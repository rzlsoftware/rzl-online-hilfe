...
Hier wählen Sie aus den in der Verwaltung angelegten [Aufgabenvorlagen](/kis/aufgabenverwaltung/arbeiten-mit-aufgabenvorlagen/)
...
Innerhalb der [Stammdaten des Klienten](/kis/stammdaten/klientenstammdaten/) können die in der Verwaltung angelegten
...
[Quotenplanung](/kis/finanz-online/aufruf-status-der-quotenerfuellung/#quotenplanung) benötigt.
...
alle Klienten in der Liste markiert werden sollen, kann ![Alle-Auswählen-Symbol](<img/image79.png>) ausgewählt werden. Die Hakerl können gesamt durch Anwahl des Symbols rechts daneben wieder gelöscht werden. Natürlich können Sie die
 [Liste filtern](/kis/allgemeine-programmbedienung/programmstart-und-moegliche-funktionen/#m%C3%B6glichkeiten-der-listengestaltung).
