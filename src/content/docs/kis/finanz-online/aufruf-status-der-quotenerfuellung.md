---
title: Aufruf Status der Quotenerfüllung
program: KIS
---

Unter Status der Quotenerfüllung können Sie die aktuellen Quoten pro Finanzamt einsehen.
...
![Übersicht FinanzOnline](<img/%C3%9Cbersicht%20FinOn%20-%20Berechnungsdetail.jpg>)
...
Die einzelnen Arbeitsschritte der Quotenplanung werden [**hier**](/kis/finanz-online/eintragung-der-zugangskennung/#grundeinstellungen-f%C3%BCr-die-finanzonline-abfragen) im Detail beschrieben.
...
:::caution[Hinweis]
Da die Vollmachtsdaten täglich/wöchentlich (je nach [Einstellung](/kis/stammdaten/klientenstammdaten/)) abgeglichen werden, wird bei Nichtvorliegen einer gültigen Vollmacht die Option *Abfrage durchführen* in den RZL Board Stammdaten (Firmenansicht/Finanzämter) deaktiviert.
