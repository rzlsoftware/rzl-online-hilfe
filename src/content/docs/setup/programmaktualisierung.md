...
- Falls *Kanzlei-Informations-System / Board* oder *Firmen-Board mit
  ...
  auf die SQL-Datenbank notwendig [*siehe zusätzliche Konfigurationen*](/setup/installation-kis-board/#zus%C3%A4tzliche-konfigurationen-optional).
