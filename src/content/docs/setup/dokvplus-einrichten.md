---
title: Dokumentenverwaltung Plus einrichten
program: setup
---
...
wiederherstellen. Eine genauere Beschreibung finden Sie im [*KIS Handbuch*](/kis/).
...
- **Nicht versendetes Dokument:**
    ...
    Dieser Vorgang ist im KIS-Handbuch [*beschrieben*](/kis/arbeitsablaeufe/e-mail/#%C3%BCbernommene-e-mails-nachtragen-und-markieren).
