---
title: Installation RZL Kanzlei-Informations-System (KIS)/Board (FIBU Next, HON Next)
program: setup
---
...
Gehen Sie wie in Kapitel [*Expertenmodus*](/setup/installation/#expertenmodus-zb-f%C3%BCr-netzwerkinstallation)
beschrieben vor.
