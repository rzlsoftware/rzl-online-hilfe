...
-   *Aktivitäten erzeugen*
    ...
    eingetragen werden (siehe [Programmaktivitäten zuordnen](/le-next/einstellungen/zeiterfassung/#programmaktivit%C3%A4ten-zuordnen)).

-   *Leistungen erfassen*

    Ist dieses Feld aktiv, öffnet sich bei der Erfassung von
    Telefonprotokollen und Postausgängen direkt im RZL KIS ein extra
    Fenster zum Eingeben der Leistung (vgl. [Telefonprotokoll/Postausgang](/le-next/leistungserfassung/eingabe-einer-leistungszeile-ausserhalb-der-le/#mittels-telefonprotokollpostausgang)).
