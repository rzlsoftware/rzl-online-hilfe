...
Ebenso ist es möglich, im [Unternehmensbereich](/hon-next/unternehmensbereiche/) selbst die Zuordnung der
...
Schaltfläche *Klienten zuordnen* **(8)** oder in den [Stammdaten des Klienten](/hon-next/stammdaten-klienten/) im Bereich HON hinterlegt werden. Immer wenn Sie eine Note
