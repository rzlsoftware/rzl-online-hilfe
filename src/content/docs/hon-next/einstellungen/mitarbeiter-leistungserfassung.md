---
title: Mitarbeiter Leistungserfassung
program: HONNext
---
...
verpflichtend* zu machen (siehe [Tätigkeiten](/hon-next/stammdaten-hon-next/taetigkeiten/)).
...
(vgl. [Mitarbeiterübersicht](/hon-next/mitarbeiteruebersicht/)).

:::caution[Hinweis]
Bei der digitalen Stempeluhr ist der Import von Arbeitszeiten [Import von Arbeitszeiten](/hon-next/datenuebernahme/#datenimport-leistungen-und-arbeitszeiten) nicht möglich.
...
Der Hinweis auf Überschneidungen ist auch in der Mitarbeiterübersicht ersichtlich (siehe Kapitel [Mitarbeiterübersicht](/hon-next/mitarbeiteruebersicht/)).
