...
[Erfassungsklienten](/hon-next/verrechnungs-erfassungsklient/allgemeines/) auf der Note mit dem Klientennamen extra
...
*Tätigkeiten ohne Betrag vorreihen* beziehen sich auf *[Tätigkeiten](/hon-next/stammdaten-hon-next/taetigkeiten/) ohne
Betrag in Note*.
...
Kapitel [Notenerstellung](/hon-next/notenerstellung/notenerstellung/#notenzeilen-gruppieren).
...
Setzen Sie diese Option, damit Sie mit Anzahlungsrechnungen arbeiten können (vgl. Kapitel [Anzahlungsrechnungen](/hon-next/anzahlungsrechnungen/allgemein/)).
...
werden (siehe [Note zurücksetzen](/hon-next/notenuebersicht/#note-zur%C3%BCcksetzen)).
...
:::caution[Hinweis]
Der Vorschlag der Debitorennummer ist in den Klientenstammdaten (siehe [Buchhaltung](/hon-next/stammdaten-klienten/#buchhaltung)) ersichtlich.
