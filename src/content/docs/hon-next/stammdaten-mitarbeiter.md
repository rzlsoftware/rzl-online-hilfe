...
zum Mitarbeiter-Tarifschema finden Sie im Kapitel [Tarifschemata](/hon-next/stammdaten-hon-next/tarifschemata/).
...
finden Sie im Kapitel [Arbeitszeitmodelle](/hon-next/stammdaten-hon-next/arbeitszeitmodelle/).
Das Arbeitszeitmodell wird unter anderem für die
Leistungserfassung der Mitarbeiter benötigt. Weiterführende
Informationen zum Urlaub finden Sie im Kapitel [Urlaubskartei](/hon-next/mitarbeiteruebersicht/urlaubskartei/). Die Urlaubsinformationen werden als
...
Mit dem Feld *Abweichende Arbeitszeitaufzeichnung* kann für den gewählten Mitarbeiter die Art der Arbeitsaufzeichnung abweichend zum Standard hinterlegt werden, vgl. Kapitel [Mitarbeiter-Leistungserfassung](/hon-next/einstellungen/mitarbeiter-leistungserfassung/).
