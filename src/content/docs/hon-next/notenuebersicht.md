...
-   **Rechnung Nr.:** Nur, wenn die Noten finalisiert wurden, erhalten
    ...
    finden Sie im Kapitel [Nummernbereiche](/hon-next/stammdaten-hon-next/nummernbereiche/) beschrieben.

-   **Zustellung:** Die Art der Zustellung, die Sie bei der
    Notenerstellung ausgewählt haben, wird angezeigt. Siehe [Stammdaten Klienten](/hon-next/stammdaten-klienten/).

-   Klienten-Nummer

-   Klienten-Name

-   **Rechnungssteller:** Der Rechnungsteller ist im Kapitel [Unternehmensbereiche](/hon-next/unternehmensbereiche/) beschrieben.
...
-   **Anmerkung** (vgl. Kapitel [Notenerstellung/Einstellungen](/hon-next/notenerstellung/notenerstellung/#einstellungen))

-   **Zusatztext auf Note** (vgl. Kapitel [Honorarnote](/hon-next/stammdaten-klienten/#honorarnote))

-   [Schlussnote](/hon-next/pauschalverrechnung/schlussnote/)
...
([Speicherbare Layouts](/hon-next/auswertungen/speicherbare-layouts/)).
...
:::
Sollten Sie in den [Grundeinstellungen](/hon-next/einstellungen/grundeinstellungen/) bereits die Einstellung „*Note beim Speichern
...
je Note ([Einstellungen](/hon-next/notenerstellung/notenerstellung/#einstellungen)) geändert werden. Sollten weitere Änderungen
...
*erweitertes Finalisieren* ([Note finalisieren](/hon-next/notenuebersicht/#note-finalisieren)).
