---
title: So aktualisieren Sie Ihren SQL Server via Windows Updates
program: technik
---

<span id="so-aktualisieren-sie-ihren-sql-server-via-windows-updates" class="legacy-anchor" aria-hidden="true"></span>
KB0022
...
- Überprüfung der SQL Server-Version (z. B. 2019, 2022, 2025), um kompatible Updates zu identifizieren
...
<span id="update-uberprufen" class="legacy-anchor" aria-hidden="true"></span>
### Update überprüfen
...
<span id="testen-der-funktionalitat" class="legacy-anchor" aria-hidden="true"></span>
