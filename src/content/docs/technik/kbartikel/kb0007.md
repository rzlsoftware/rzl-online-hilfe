---
title: Der RZL PDF-Manager Premium kann nicht installiert werden
program: technik
---

<span id="der-rzl-pdf-manager-premium-kann-nicht-installiert-werden" class="legacy-anchor" aria-hidden="true"></span>
KB0007
...
### Lizenz erweitern
Erweitern Sie Ihre vorhandene Lizenz auf das Kanzlei-Informations-System. Setzen Sie sich dazu mit unserm Vertrieb in Verbindung.
...
<span id="option-a-installation-uber-rzl-admin" class="legacy-anchor" aria-hidden="true"></span>
...
![PDF Manager Treiber im Admin](img/kb0007_pdfManagerTreiberimAdmin.png#only-light)
![PDF Manager Treiber im Admin](img/kb0007_pdfManagerTreiberimAdmin.png#only-dark) 
