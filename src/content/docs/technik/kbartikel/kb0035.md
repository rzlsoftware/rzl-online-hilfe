---
title: Ausfall RZL Dienst
program: technik
---

<span id="ausfall-rzl-dienst" class="legacy-anchor" aria-hidden="true"></span>
KB0035

## Problembeschreibung

Der RZL Dienst wird zum aktuellen Zeitpunkt nicht mehr ausgeführt. Ein Ausfall führt zum temporären Funktionsverlust von Programmen und Modulen, welche auf den RZL Dienst angewiesen sind:
...
![Ausfall RZL Dienst](img/kb0035_AusfallRzlDienst.png)

**RZL-Dienst-Ausfall – Sicht aus dem RZL Admin**  

![Ausfall RZL Dienst](img/kb0035_AusfallRZLDienstAdmin.png)
