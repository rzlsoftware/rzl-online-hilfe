---
title: RZL Datenbank Setup Fehlercodes
program: technik
---

<span id="rzl-datenbank-setup-fehlercodes" class="legacy-anchor" aria-hidden="true"></span>
KB0026
...
<span id="ursache_1" class="legacy-anchor" aria-hidden="true"></span>
### Ursache
...
<span id="losung_1" class="legacy-anchor" aria-hidden="true"></span>
### Lösung

Die folgende Anleitung richtet sich an EDV-Betreuer/Systemadministratoren.

<span id="rechte-auf-der-datenbank-vergeben_1" class="legacy-anchor" aria-hidden="true"></span>
#### Rechte auf der Datenbank vergeben
...
<span id="zuweisung-der-benutzerrolle-in-der-datenbank_1" class="legacy-anchor" aria-hidden="true"></span>
#### Zuweisung der Benutzerrolle in der Datenbank
...
4. Unter **Sicherheit** wählen Sie **Bearbeiten...** und **Hinzufügen...**.
     ...
     2. Sollte es sich beim Sicherungspfad um einen Netzwerkpfad auf einem anderen Computer handeln, müssen Sie statt des Dienstbenutzers den Computer, auf dem der SQL Server installiert ist, mit **Vollzugriff** berechtigen.
