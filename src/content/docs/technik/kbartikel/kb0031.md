---
title: Fehlende SQL-Server-Rechte
program: technik
---

<span id="fehlende-sql-server-rechte" class="legacy-anchor" aria-hidden="true"></span>
KB0031
...
**Installation KIS/Board** > [Zusätzliche Konfigurationen](/setup/installation-kis-board/).
