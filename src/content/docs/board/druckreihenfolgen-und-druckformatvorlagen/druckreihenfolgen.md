...
Markieren Sie den gewünschten Ausdruck und übernehmen Sie ihn mit dem Zuordnen-Pfeil ![Pfeil zum Zuordnen](<img/zuordnen%20Pfeil.png>) oder Drag & Drop in die Spalte Druckschritte. Jeder übernommene Ausdruck erscheint dort als eigener, nummerierter Druckschritt. Die Reihenfolge der Druckschritte ändern Sie per Drag & Drop mittels ![Verschieben-Symbol](<img/verschieben%20Symbol.png>).
...
![Klient zuordnen](<img/Klient%20Zuordnen.png>)
...
![Ausführen](<img/Ausf%C3%BChren_Eingabe%20Zeitraum.png>)
...
- ![läuft](<img/l%C3%A4uft.png>) Läuft, der Vorgang wird gerade ausgeführt
...
![Hinweis übersprungener Ausdruck](<img/Hinweis%20%C3%BCbersprungener%20Ausdruck.png>)
