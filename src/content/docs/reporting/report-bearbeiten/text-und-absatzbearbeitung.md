---
title: Text- und Absatzbearbeitung
program: Reporting
---
...
Mit Hilfe einer [Bedingungsformel](/reporting/formeln/einfuegen-und-bearbeiten-von-formeln/) werden Absätze nur gedruckt, wenn die im Absatz integrierte Formel erfüllt wird.
...
Das Eingabefeld wird nun in gelber Farbe dargestellt. Sie müssen nun noch definieren, dass es sich um keine Formel, sondern um ein Eingabefeld handelt. Dies können Sie über die [*Formeleigenschaften*](/reporting/eigenschaftsfenster/formel/) ändern (*Ansicht / Eigenschaftsfenster / Formel*).

![Image](img/image46.png)

Wir empfehlen das Häkchen bei *Nicht löschbar* zu setzen, damit das Eingabefeld nicht versehentlich gelöscht werden kann. Beim Punkt [*Direkteingabe*](/reporting/eigenschaftsfenster/formel/) müssen Sie noch einstellen, um welche Eingabe es sich handelt.
...
:::caution[Hinweis]
Die Ausrichtung von Absätzen bzw. komplexeren Formatierungen innerhalb eines Absatzes können oft in einer [Tabelle](/reporting/tabelle/) schneller und präziser gelöst werden.
