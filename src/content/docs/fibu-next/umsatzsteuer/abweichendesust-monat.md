---
title: Buchen mit abweichendem Umsatzsteuer-Monat
program: FIBUNext
---
...
#### Funktionen im Datumsfeld
**Abweichenden USt-Monat einmalig aktivieren**: Für die aktuelle Buchung, bei Teilbuchungen bleibt dieses Verhalten bestehen.

**Abweichenden USt-Monat dauerhaft / deaktivieren**: Bei der nächsten Buchung wird der zuletzt verwendete Wert übernommen.

:::caution[Hinweis]
Die Funktion **einmalig aktivieren** ist grau, wenn der abweichende USt-Monat dauerhaft aktiviert ist.

:::
Eine Buchung mit abweichendem USt-Monat wird berücksichtigt bei:
