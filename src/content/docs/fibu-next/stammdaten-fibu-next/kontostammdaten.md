...
Für die Beschreibung der verfügbaren Eingabefelder siehe Kapitel [Kontenplan anlegen](/fibu-next/stammdaten/kontenplane/). Die Funktionen *Neues Konto* ***(2)*** sowie *Konto löschen* ***(3)*** und *Kontonummer ändern* ***(4)*** werden ebenso in diesem Kapitel beschrieben.
...
Einzige Ausnahme ist, wenn sich der betroffene IBAN in der Ausschlussliste IBAN (siehe [Ausschlussliste IBAN](/fibu-next/stammdaten-fibu-next/iban-ausschlussliste/)).
