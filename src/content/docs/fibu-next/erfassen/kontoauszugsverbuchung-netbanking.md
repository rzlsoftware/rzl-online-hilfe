---
title: Verarbeitung von Kontodaten mittels CSV/TXT-Datei (Netbanking)
program: FIBUNext
---
...
Zusätzlich sind vorab die entsprechenden Bankverbindungen unter dem Menüpunkt *Stammdaten / FIBU Bankverbidung* zu hinterlegen (siehe Kapitel [FIBU Bankverbindungen](/fibu-next/stammdaten-fibu-next/fibu-bankverbindungen/)).
...
![Hereinspielen der Importdatei](img/image7.png)
...
![Hereinspielen der Importdatei (Teil 2)](img/image8.png)
...
![Hereinspielen der Importdatei (Teil 3)](img/image12.png)
![Hereinspielen der Importdatei (Teil 4)](img/image9png)
...
![Hereinspielen der Importdatei (Teil 7)](img/image11.png)
...
![Hereinspielen der Importdatei (Teil 8)](img/image14.png)
...
![Hereinspielen der Importdatei (Teil 9)](img/image15.png)
...
![Auszug verbuchen](img/image16.png)

![Auszug verbuchen (Teil 2)](img/image17.png)

In den Buchungsoptionen ***(1)*** finden Sie die Informationen aus den Stammdaten der FIBU Bankverbindung (siehe Kapitel [FIBU Bankverbindungen](/fibu-next/stammdaten-fibu-next/fibu-bankverbindungen/)) inkl. dem Anfangssaldo des hinterlegten Sammelkontos.
...
![Auszug verbuchen (Teil 3)](img/image18.png)
