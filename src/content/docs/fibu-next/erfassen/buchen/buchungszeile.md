...
**Belegkreis**  
Sie können zwischen den Belegkreisen wählen, die unter *Stammdaten / Belegkreise* angelegt wurden. (Der Belegkreis EB kann nur im Stapel Eröffnungsbilanz bebucht werden. Siehe Kapitel [Eröffnungsbilanz](/fibu-next/erfassen/eroeffnungsbilanz/))
...
Mit rechter Maustaste und Anwahl *Splitbuchung* oder mit der *F5-Taste* können Sie zu einer Splitbuchung wechseln.
...
Näheres zum Buchen mit Steuer bzw. den einzelnen Steuercodes finden Sie im Kapitel [Umsatzsteuer](/fibu-next/umsatzsteuer/).
...
Das Anlegen von standardisierten Buchungstexten (siehe Kapitel [Buchungstextgruppen](/fibu-next/stammdaten-fibu-next/buchungstextgruppen/)) bedeutet eine wesentliche Zeitersparnis beim Buchen, da die jeweils angelegten Buchungstexte mit der F3-Taste aufgerufen und mit der ENTER-Taste einfach übernommen werden können.
...
![Belegverarbeitung](<img/image3.png>)
