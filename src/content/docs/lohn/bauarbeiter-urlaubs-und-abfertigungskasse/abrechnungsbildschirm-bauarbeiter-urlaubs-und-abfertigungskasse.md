---
title: Abrechnungsbildschirm Bauarbeiter- Urlaubs- und Abfertigungskasse
program: LOHN
---
...
Das in den Klientenstammdaten im *Registerblatt NeuFöG, BUAK, ELDA* eingetragene *Betriebskennzeichen* und die *Direktauszahlung* ja/nein werden angezeigt. Wenn [Direktauszahlung](/lohn/abrechnungsbildschirme/fixe-lohnarten/) aktiviert ist, kann die Urlaubsentgelt-Verrechnung nicht durchgeführt werden. Die Erfassung ist derzeit nur manuell am Portal der BUAK möglich.
...
Wenn im [Abrechnungsbildschirm *Kollektivvertrag*](/lohn/abrechnungsbildschirme/kollektivvertrag/) der Dienstnehmer richtig eingestuft wurde, kann der Stundensatz laut Kollektivvertrag mit der *F2-Taste* übernommen werden.
