...
Diese Grundeinstellungen können auch im Menüpunkt *Stamm / Klient / [Details Rückstellungen (2)](/lohn/rueckstellungen/stammdaten/)* aufgerufen bzw. bearbeitet werden.
...
Hier wird der in den *Details* eingetragene *Teiler* angezeigt. Innerhalb der [Urlaubskartei](/lohn/abrechnungsbildschirme/urlaub/) oder in der angezeigten Dienstnehmerliste kann pro Dienstnehmer ein individueller Teiler bestimmt werden.
