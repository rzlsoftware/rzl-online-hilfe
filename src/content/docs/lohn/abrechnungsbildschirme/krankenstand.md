...
Im ersten Bereich des Bildschirms werden in den Feldern *Anrechnung ab* … *als* das Eintrittsdatum und die Zuordnung (Arbeiter, Angestellter, Lehrling) automatisch eingetragen. Die Zuordnung zu Arbeiter, Angestellter oder Lehrling erfolgt aufgrund der im Abrechnungsbildschirm [*Sozialversicherung*](/lohn/abrechnungsbildschirme/sozialversicherung/) ausgewählten Beschäftigtengruppe.
...
In diesem Bereich können die Krankenstandstage eingetragen werden. Die Eintragung kann manuell erfolgen oder durch eine automatische [Übernahme der Krankenstandsbescheinigungen](/lohn/elektronische-meldungen-oegk/krankenstandsbescheinigungen/) von Elda.
...
Die bloße Änderung der Beschäftigtengruppe im Abrechnungsbildschirm [*Sozialversicherung*](/lohn/abrechnungsbildschirme/sozialversicherung/) bewirkt keine Änderung im Bereich der Krankenstandsverwaltung.
