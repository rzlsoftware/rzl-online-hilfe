...
In diesem Eingabebildschirm kann die *Urlaubskartei* des Dienstnehmers geführt werden. Der [Ausdruck der Urlaubskartei](/lohn/ausdrucke-allgemein/ausdruck-abrechnungen/) ist im *Ausdruckmenü* unter *Stammdaten* möglich. Die Eintragungen in der Urlaubskartei werden auch für die Berechnung der [Urlaubsrückstellung](/lohn/rueckstellungen/urlaubsrueckstellung/) verwendet. Es können wahlweise *Werktage*, *Arbeitstage* oder *Stunden* eingetragen werden.
...
Im Abrechnungsbildschirm [*Eintritt*](/lohn/abrechnungsbildschirme/eintritt/) können die Arbeitstage des Dienstnehmers für jeden Tag der Woche einzeln festgelegt werden. Wenn diese Eintragungen für die Ermittlung der Urlaubsdauer übernommen werden sollen, muss dieses Feld aktiviert werden.
...
Hier kann für den Dienstnehmer ein *abweichender Monatsteiler* eingetragen werden. Der Monatsteiler wird für die Berechnung der [Urlaubsrückstellung](/lohn/rueckstellungen/urlaubsrueckstellung/) verwendet.
...
Auf den [Abrechnungen der Dienstnehmer](/lohn/ausdrucke-allgemein/ausdruck-abrechnungen/) kann die Urlaubskartei wahlweise normal oder im *Detail* gedruckt werden.
