...
Das Trinkgeld erhöht nur die Sozialversicherungsgrundlage, nicht jedoch den Auszahlungsbetrag. Falls [*Aliquotierung*](/lohn/abrechnungsbildschirme/stammdaten-fristen/) aktiviert ist, erfolgt eine automatische Aliquotierung dieses Betrags bei Ein- oder Austritt während des Monats.
...
Aufgrund des im Abrechnungsbildschirm [*Austritt*](/lohn/abrechnungsbildschirme/austritt/) eingetragenen Austrittsgrunds (Präsenz- bzw. Zivildienst, Wochengeld) wird vom Programm automatisch die Bemessungsgrundlage in das jeweilige Feld eingetragen.
...
Siehe [Start-Up-Mitarbeiterbeteiligung](/lohn/abrechnungen-sonderfaelle/start-up-mitarbeiterbeteiligung/)
