...
Durch Anwahl der *F2-Taste* können die in den *Klientenstammdaten* hinterlegten [Kollektivverträge](/lohn/klientenstammdaten/stammdaten-klient/kostenstellen-kostentraeger-krankenstandsbescheinigungen-kv/) aufgerufen und dem Dienstnehmer zugeordnet werden.
...
Dieser Punkt wurde ursprünglich für den Kollektivvertrag Handel Angestellte geschaffen und kann aber nun auch für alle anderen Kollektivverträge angewendet werden. (Näheres zur Umstufung KV-Handel finden Sie [hier](/lohn/kollektivvertraege/umstellung-kv-handel-angestellte/)).
...
In bestimmten Kollektivverträgen (z. B. Informationstechnik) verbleibt man eine bestimmte Zeitdauer in einer Gruppe (z. B. Einstiegsstufe) und wechselt dann automatisch in die nächsthöhere Gruppe (z. B. Regelgruppe). Diese [Folgegruppen](/lohn/kollektivvertraege/wann-sind-folgegruppen-notwendig/) werden im jeweiligen Kollektivvertrag verknüpft.
...
Auf die hier angezeigten Werte kann im Rahmen der automatischen Berechnung mit [Lohnformeln](/lohn/lohnformeln/verwaltung-der-lohnformeln-innerhalb-eines-klienten/anlage-von-lohnformeln/) zugegriffen werden.
...
:::
Die abonnierten Kollektivverträge müssen in den *Klientenstammdaten* zugeordnet werden. Die Zuordnung erfolgt im [Registerblatt *Kostenstellen, Krankenstandsbesch., KV* im Bereich *Kollektivverträge*](/lohn/klientenstammdaten/stammdaten-klient/kostenstellen-kostentraeger-krankenstandsbescheinigungen-kv/).
...
Auf die hier eingetragenen Werte kann im Rahmen der automatischen Berechnung mit [Lohnformeln](/lohn/lohnformeln/verwaltung-der-lohnformeln-innerhalb-eines-klienten/anlage-von-lohnformeln/) zugegriffen werden.
