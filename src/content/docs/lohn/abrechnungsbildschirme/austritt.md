...
Eingabe des arbeitsrechtlichen Endes des Dienstverhältnisses. Das Austrittsdatum muss im Abrechnungsmonat liegen. Aufgrund des Austrittsdatums werden die SV-Tage und LSt-Tage berechnet. Ist [*Aliquotierung*](/lohn/abrechnungsbildschirme/stammdaten-fristen/) angewählt, wird der Bruttolohn entsprechend aliquotiert. In den nächsten Monaten wird die Abrechnung automatisch unterdrückt. Der Dienstnehmer kann dann nur mittels Wiedereintritt im selben Monat oder zu einem späteren Zeitraum abgerechnet werden.

**Grund**

Eingabe des Austrittsgrundes durch Auswahl aus der von der ÖGK vorgegebenen Liste. Für die Abmeldung muss ein Austrittsgrund angewählt werden. Bei der Eingabe eines *sonstigen Grundes* wird auf die angelegten [*Standardtexte*](/lohn/kanzleitexte-und-kanzleilohnkontenplaene/) zurückgegriffen.
...
:::
:::caution[Hinweis]
Informationen zur Urlaubsersatzleistung bei Tod des Dienstnehmers finden Sie [hier](/lohn/abrechnungen-sonderfaelle/urlaubsersatzleistung-tod-dienstnehmers/).
...
Kehrt der Dienstnehmer nach dem Präsenz- bzw. Zivildienst **nicht** mehr zurück, ist wie [hier](/lohn/abrechnungen-sonderfaelle/endgueltige-beendigung-arbeitsrechtlich-aufrechten-dienstverhaeltnissen/) beschrieben vorzugehen.
