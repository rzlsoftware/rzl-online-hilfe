...
Vgl. [Abrechnungen der Dienstnehmer bereitstellen](/lohn/rzl-klientenportal/)
...
Wenn in den Stammdaten des Klienten im Registerblatt [*Neufög, BUAK, ELDA*](/lohn/klientenstammdaten/stammdaten-klient/neufoeg-buak-elda/) das Feld *externe DN-Nummer* aktiviert ist, kann hier diese extra Nummer eingetragen werden. Diese Nummer kann beim Ausdruck der Abrechnungen, beim Datenimport und Datenexport verwendet werden.
...
vgl. [Arbeitsstätten – Lohnzettel Finanz](/lohn/klientenstammdaten/arbeitsstaetten-lohnzettel-finanz/)
...
Ist das Kind dem Dienstnehmer gegenüber unterhaltsberechtigt, ist dieses Feld zu aktivieren. Die Unterhaltspflicht wird bei der automatischen [Exekutionsberechnung](/lohn/exekutionen/exekutionsberechnung/) berücksichtigt. Weiters wird das Kind beim Ausdruck der Drittschuldnererklärung als unterhaltsberechtigt angedruckt.

**Kind § 106 EStG**

Liegt ein Kind gemäß § 106 EStG vor, so kann dieses Feld aktiviert werden. Im Abrechnungsbildschirm [*Lohnsteuer*](/lohn/abrechnungsbildschirme/lohnsteuer/) im Bereich *Absetzbeträge* kann im Feld *Anzahl Kinder §&nbsp;106* durch Anwahl der *F2-Taste* die Anzahl der Kinder gemäß §&nbsp;106&nbsp;EStG übernommen werden.
...
Hierfür legen Sie sich unter *Abrechnungen / [Neuanlage Dienstnehmer](/lohn/abrechnungen/neuanlage-dienstnehmer/)* den betroffenen Dienstnehmer an.

Erfassen Sie im Abrechnungsbildschirm [*Stammdaten Dienstnehmer*](/lohn/abrechnungsbildschirme/stammdaten-dienstnehmer/) folgende Pflichtfelder:
