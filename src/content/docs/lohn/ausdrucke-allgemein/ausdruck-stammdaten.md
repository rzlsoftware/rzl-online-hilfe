...
Dieser Programmteil ermöglicht den Ausdruck der beim Klienten angelegten [Arbeitsstätten](/lohn/klientenstammdaten/arbeitsstaetten-lohnzettel-finanz/).
...
- **Liste**
    ...
    Der Ausdruck der Liste der Dienstnehmer kann wahlweise *mit* oder *ohne Fristen* erfolgen. Bei diesen Fristen handelt es sich um die im Abrechnungsbildschirm [*Stammdaten Fristen*](/lohn/abrechnungsbildschirme/stammdaten-fristen/) eingetragenen *Anmerkungen* (z. B. 1.4.2022 Gehaltserhöhung). Im Feld *Stichtagsmonat* kann das für den Ausdruck der Fristen gewünschte Monat eingetragen werden.

    Sollen die im Abrechnungsbildschirm [*Dienstnehmer-Notizen*](/lohn/abrechnungsbildschirme/dienstnehmer-notizen/) geführten Eintragungen angedruckt werden, ist das Feld *mit Notizen* anzuwählen.
...
Dieser Programmteil ermöglicht den Ausdruck der innerhalb des Klienten angelegten [Lohnformeln](/lohn/lohnformeln/verwaltung-der-lohnformeln-innerhalb-eines-klienten/anlage-von-lohnformeln/) und der Lohnformel-Zuordnungen.
...
Im Programmteil *Ausdruck / Stammdaten / Dienstzettel / Dienstvertrag* können die bei dem jeweiligen Dienstnehmer im Abrechnungsbildschirm [*Dienstzettel*](/lohn/abrechnungsbildschirme/dienstzettel/) angelegten Dienstzettel ausgedruckt werden.
...
Die im Abrechnungsbildschirm [*Urlaub*](/lohn/abrechnungsbildschirme/urlaub/) angelegte Urlaubskartei kann im Menüpunkt *Ausdruck / Stammdaten / Urlaubskartei* ausgedruckt werden. Es gibt hier die Möglichkeit, nach *aktuellem Urlaubsjahr*, *Gesamte Kartei* oder einem *individuellen Zeitraum* die Kartei auszudrucken. Wird *Einzeldruck* aktiviert, wird für jeden Dienstnehmer eine eigene Seite erstellt - ideal zur Ablage im Personalakt.

**Krankenstände**

Der Menüpunkt *Ausdruck / Stammdaten / Krankenstände* ermöglicht den Ausdruck der im Abrechnungsbildschirm [*Krankenstand*](/lohn/abrechnungsbildschirme/krankenstand/) angelegten Kranken­standsaufzeichnungen. Es gibt hier die Möglichkeit, nach *aktuellem Krankenstandsjahr*, *Gesamte Kartei* oder einem *individuellen Zeitraum* die Kartei auszudrucken. Wird *Einzeldruck* aktiviert, wird für jeden Dienstnehmer eine eigene Seite erstellt - ideal zur Ablage im Personalakt.

**Zeitausgleichskartei**

Die im Abrechnungsbildschirm [*Zeitausgleich*](/lohn/abrechnungsbildschirme/zeitausgleich/) vorgenommenen Eintragungen, können im Programmteil *Ausdruck / Stammdaten / Zeitausgleichskartei* ausgedruckt werden. Es gibt hier die Möglichkeit, nach *aktuellem Kalenderjahr*, *Gesamte Kartei* oder einem *individuellen Zeitraum* die Kartei auszudrucken. Wird *Einzeldruck* aktiviert, wird für jeden Dienstnehmer eine eigene Seite erstellt - ideal zur Ablage im Personalakt. Sie haben hier die Auswahl, ob Sie *alle* (vier) *einzelnen Karteien* oder ausgewählte Karteien drucken.

**Dienstverhinderungskartei**

Die im Abrechnungsbildschirm [*Dienstverhinderung*](/lohn/abrechnungsbildschirme/dienstverhinderung/) vorgenommenen Eintragungen, können im Programmteil *Ausdruck / Stammdaten / Dienstverhinderung* ausgedruckt werden. Es gibt hier die Möglichkeit, nach *aktuellem Arbeitsjahr*, *Gesamte Dienstverhinderungskartei* oder einem *Datumsbereich* die Kartei auszudrucken. Wird *Einzeldruck* aktiviert, wird für jeden Dienstnehmer eine eigene Seite erstellt - ideal zur Ablage im Personalakt. Sie haben hier die Auswahl, ob Sie eine *Auswahl* der *Dienstverhinderungen* für den Ausdruck vornehmen möchten.
...
Die im Abrechnungsbildschirm [*Zeitausgleich*](/lohn/abrechnungsbildschirme/zeitausgleich/) vorgenommenen Eintragungen im unteren Abschnitt *Zeitausgleich (wird nicht bei Zeitausgleichsrückstellung berücksichtigt),* können im Programmteil *Ausdruck / Stammdaten / Zeitausgleich* ausgedruckt werden.

**Monatssalden Urlaub, Krankenstand, Zeitausgleich**

Dieser Ausdruck ermöglicht den Ausdruck einer Dienstnehmerliste mit den aktuellen Salden der [Urlaubskartei](/lohn/abrechnungsbildschirme/urlaub/), der [Krankenstandskartei](/lohn/abrechnungsbildschirme/krankenstand/) und der [Zeitausgleichskartei](/lohn/abrechnungsbildschirme/zeitausgleich/).
...
Im Programmteil *Ausdruck / KV-Einstufungen* kann eine Übersicht über die [KV-Einstufungen](/lohn/kollektivvertraege/abrechnungsbildschirm-kollektivvertrag/) der Dienstnehmer ausgedruckt werden.
