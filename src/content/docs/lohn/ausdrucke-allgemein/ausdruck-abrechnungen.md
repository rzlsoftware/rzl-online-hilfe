...
Der Ausdruck der Abrechnungen kann auch nach angelegten [Auswahlkriterien](/lohn/auswahlkriterien/) erfolgen.
...
:::note[Tipp]
Das Hochladen von Abrechnungen auf das RZL-Klientenportal wird bei [*Abrechnungen für Dienstnehmer bereitstellen*](/lohn/rzl-klientenportal/) beschrieben.
...
Weiters besteht in diesem Programmteil die Möglichkeit, die *Dienstgebergesamtkosten* (inkl. Lohnnebenkosten), die *Zeitausgleichsverwaltung* (Abrechnungsbildschirm [*Zeitausgleich*](/lohn/abrechnungsbildschirme/zeitausgleich/)) und die [*Urlaubsverwaltung*](/lohn/abrechnungsbildschirme/urlaub/) können entweder *normal* oder *detailliert* ausgedruckt werden.
...
Die im Abrechnungsbildschirm [*Eintritt*](/lohn/abrechnungsbildschirme/eintritt/) hinterlegte Wochenarbeitszeit des Dienstnehmers wird durch Anwahl des Feldes *Wochenarbeitszeit drucken* auf der Abrechnung angezeigt.

Wenn das Modul [*Kollektivverträge*](/lohn/kollektivvertraege/abrechnungsbildschirm-kollektivvertrag/) lizensiert ist, werden durch Anwahl des Feldes
