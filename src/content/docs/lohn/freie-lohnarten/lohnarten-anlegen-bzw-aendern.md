---
title: Lohnarten anlegen / ändern
program: LOHN
---
...
Lediglich hinsichtlich der Zuordnung der Lohnart in den Eingabefeldern „Bemessung Sonderzahlung“ bis „Bemessung Urlaubsrückstellung Sonderzahlung“ kann eine spätere Korrektur erfolgen. Ein [Repair der Bemessungsgrundlagen](/lohn/repair/) ist nachfolgend notwendig.
...
|        5         | Erhöhung der SV-Bemessungsgrundlage laufender Bezug ([Altersteilzeit](/lohn/abrechnungen-sonderfaelle/abrechnung-altersteilzeit/)) (kein ANA) |
|        6         | Erhöhung der SV-Bemessungsgrundlage Sonderzahlung ([Altersteilzeit](/lohn/abrechnungen-sonderfaelle/abrechnung-altersteilzeit/)) (kein ANA)   |
|        7         | nur BV-pflichtig                                                                                                                            |
...
Wird dieses Feld aktiviert, wird die freie Lohnart in der Sonderzahlungsberechnung miteingerechnet, wenn im Zuge der Abrechnung mit [Lohnformeln](/lohn/lohnformeln/formelsyntax/lohnarten/) gearbeitet wird.
...
:::note[Tipp]
Bezüglich Exekutionen vergleiche [Exekutionen](/lohn/exekutionen/exekutionsberechnung/).
...
Wenn das Feld *Verwendung ÜSt.-Grunddaten* aktiviert ist, übernimmt das Programm die Einstellungen (Überstundenteiler oder abw. Überstundengrundlohn) aus dem Abrechnungsbildschirm [*Über-/Mehrarbeitsstunden*](/lohn/abrechnungsbildschirme/ueber-und-mehrarbeitsstunden/).
