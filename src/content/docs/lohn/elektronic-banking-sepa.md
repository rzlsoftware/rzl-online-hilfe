...
Durchgeführte Überweisungen von Lohnabrechnungen werden bei den einzelnen Dienstnehmern vermerkt. Damit ist sichergestellt, dass eine Überweisung nicht zweimal erfolgen kann. Ist es erforderlich, dass Sie die Überweisung nochmals ausdrucken bzw. die Überweisungsdatei nochmals erstellen, müssen Sie vorher ein [*Repair*](/lohn/repair/) der Überweisungen durchführen.
...
Für die Überweisung legen Sie nun fest, von welchem [Bankkonto](/lohn/klientenstammdaten/stammdaten-klient/bank-ueberweisung-zahltag/) (*Dienstgeber-Banken)* die Zahlung erfolgen soll.
