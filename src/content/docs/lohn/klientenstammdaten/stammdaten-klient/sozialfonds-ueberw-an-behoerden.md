---
title: Sozialfonds, Überweisung an Behörden
program: LOHN
---

<span id="sozialfonds-uberweisung-an-behorden" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="uberweisungen-an-sonstige-behorden" class="legacy-anchor" aria-hidden="true"></span>
...
Mit den beiden Optionen *Gewerkschaftsbeitrag* und *Betriebsratsumlage* kann nun ein Zugriff auf die beiden Felder aus dem Abrechnungsbereich [*Abzüge*](/lohn/abrechnungsbildschirme/abzuege/) erfolgen.
