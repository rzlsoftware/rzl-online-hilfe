...
Hier kann zwischen den im Listenfeld angeführten Gesundheitskassen ausgewählt werden. Wenn neben der ÖGK noch eine weitere Versicherungsanstalt geführt werden soll (z. B. Notariat), kann diese zusätzliche Gesundheitskasse über einen [Unterdienstgeber](/lohn/klientenstammdaten/unterdienstgeber/) geführt werden.
...
In diesem Feld können Sie die Beitragskontonummer des Dienstgebers eingeben. Durch die Zuordnung des Bundeslandes beim Dienstnehmer im Abrechnungsbildschirm [*Sozialversicherung*](/lohn/abrechnungsbildschirme/sozialversicherung/) wird die Erstellung der monatlichen Beitragsgrundlagenmeldungen getrennt für jedes Bundesland vorgenommen.
