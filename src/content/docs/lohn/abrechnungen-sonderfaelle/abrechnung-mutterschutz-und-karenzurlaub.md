---
title: Abrechnung Mutterschutz/Karenzurlaub
program: LOHN
---
...
In diesem Fall führen Sie im Monat des Beginns des neuerlichen Mutterschutzes einen Wiedereintritt durch. Öffnen Sie dazu den [*Eintrittsbildschirm*](/lohn/abrechnungsbildschirme/eintritt/) und erfassen Sie im Feld *Eintrittsdatum* den ersten Tag des Mutterschutzes.

Anschließend wechseln Sie in den [*Austrittsbildschirm*](/lohn/abrechnungsbildschirme/austritt/), wo Sie im Bereich *Mutterschutz / Karenzurlaub* den *voraussichtlichen Geburtstermin* eintragen. Das Programm schlägt Ihnen daraufhin automatisch den *Beginn Mutterschutz* vor und trägt im oberen Bereich den Austritt mit dem Grund Wochengeld ein.

![Image](img/image605.png){width="500"}

Im nächsten Schritt öffnen Sie den [*Sozialversicherungsbildschirm*](/lohn/abrechnungsbildschirme/sozialversicherung/) und wählen bei der Beschäftigtengruppe den Eintrag **B999 Betriebliche Vorsorge ohne SV-Pflicht** aus. Somit erfolgt nur eine Anmeldung zur Betrieblichen Vorsorge bei der ÖGK.
...
Abschließend wechseln Sie in den Bereich der [*fixen Lohnarten*](/lohn/abrechnungsbildschirme/fixe-lohnarten/) und geben im Abschnitt *BV-Bemessung für Mutterschutz* die entsprechende Bemessungsgrundlage **manuell** ein. Ein automatischer Vorschlag durch das Programm ist in diesem Fall **nicht** vorgesehen.
