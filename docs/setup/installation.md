...
4.   Wählen Sie Ihre lizenzierten RZL-Programme und die gewünschten
    zusätzlichen Komponenten aus und bestätigen Sie mit
    ...
    *Firmen-Board mit Basismodul* ist eine Datenbank (Microsoft SQL-Server)
    ...
    Bitte beachten Sie hierzu die Kapitel 12 und 13.
    ...
    1.  Geben Sie in der zusätzlichen Einstellungsseite Ihre Anwendernummer ein.
        ...
        *RZL Dokumentenverwaltung Plus* und *Digitaler Personalakt* benötigt).
...
5.  Unter *Daten-Repository* können Sie durch Anklicken von *Neu anlegen*
    ...
    Durch die Auswahl von *Kombi-Arbeitsplatz* haben Sie die Möglichkeit,
...
!!! warning "Hinweis"
    ...
    *Firmen-Board mit Basismodul* ist eine Datenbank (Microsoft SQL-Server)
    ...
    Sie beim Klick auf *Weiter* zu einer zusätzlichen Einstellungsseite (1a),
    in der Sie Datenbankeinstellungen vornehmen können. Bitte beachten Sie
    hierzu Kapitel 12 und 13.
...
Komponenten* ausgewählt werden. Bitte beachten Sie hierzu Kapitel 14.

Klicken Sie auf *Weiter* bzw. *Aktionen durchführen*, um mit dem
Installationsvorgang fortzufahren.

Abhängig von den ausgewählten Programmen wird Ihnen ein zusätzliches
