...
Spalte *Meldung* ersehen Sie, welche Klienten Sie bereits bearbeitet
haben und für welche durch *Meldung erstellen* ein Datensatz für die
Übermittlung erzeugt wird. Der *Status* zeigt Ihnen an, ob die Meldung
an FinanzOnline übermittelt wurde oder nicht – bei einer erfolgreichen
...
VJ-Quotenfälle werden mithilfe des Menüpunktes ***Vorschlag aufgrund
VJ-Meldung*** für jene bereits im Vorjahr gemeldeten Klienten die
