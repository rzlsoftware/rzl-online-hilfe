...
Erscheint der Hinweis zu 2FA Registrierung sofort nach dem Login, können Sie auf *Registrierung starten* klicken.

![2FA Registrierung starten nach Anmeldung](<img/2FA Registrierung.png>)

Die Registrierung können Sie aber auch im FinanzOnline auch unter *Benutzermenü / 2-Faktor-Authentifizierung* starten.
