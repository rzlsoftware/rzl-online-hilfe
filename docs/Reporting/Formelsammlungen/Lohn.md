...
| `DG().Beruf`{data-clipboard-text="DG().Beruf"}                                   | Art der Tätigkeit des Dienstgebers                      |
...
| `DG().FinanzDienststelle`{data-clipboard-text="DG().FinanzDienststelle"}         | Finanzamtdienststelle                                   |
...
| `DG().Lohnart().Name.Wert`{data-clipboard-text="DG().Lohnart().Name.Wert"}                 | Name der Lohnart                                                              |
...
| `DG().Monatssumme().Name`{data-clipboard-text="DG().Monatssumme().Name"}                           | Name der Lohnart                |
...
| `DG().ZR().Monat().SVTageKuerzungEFZ`{data-clipboard-text="DG().ZR().Monat().SVTageKuerzungEFZ"}           | Anzahl der abgerechneten Tage Kürzung EFZ                                             |
| `DG().ZRAktDV().Monat().SVTageKuerzungEFZ`{data-clipboard-text="DG().ZRAktDV().Monat().SVTageKuerzungEFZ"} | Anzahl der abgerechneten Tage Kürzung EFZ (aktives Dienstverhältnis)                  |
| `DG().ZR().Monat().SVTageKÜ`{data-clipboard-text="DG().ZR().Monat().SVTageKÜ"}                             | Anzahl abgerechneter SV-Tage der Kündigungsentschädigung                              |
| `DG().ZRAktDV().Monat().SVTageKÜ`{data-clipboard-text="DG().ZRAktDV().Monat().SVTageKÜ"}                   | Anzahl abgerechneter SV-Tage der Kündigungsentschädigung (aktives Dienstverhältnis)   |
...
| **Formel**                                                                                     | **Beschreibung**                                  |
| ---------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| `DG().Üst_Alle().Monat().Monat`{data-clipboard-text="DG().Üst_Alle().Monat().Monat"}           | Zeigt das ausgewählte Monat an                    |
...
| `DG().Üst_WkAktDV().Monat().Wert`{data-clipboard-text="DG().Üst_WkAktDV().Monat().Wert"}       | Wert der wiederkehrenden Überstunden (aktives DV) |
...
| **Formel**                                                                                                   | **Beschreibung**                                                      |
| ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| `DN().Monat().Abgerechnet`{data-clipboard-text="DN().Monat().Abgerechnet"}                                   | Ob das Monat abgerechnet ist – Wahr/Falsch                            |
| `DN().Monat().Jahr`{data-clipboard-text="DN().Monat().Jahr"}                                                 | Zeigt das aktuelle Jahr an                                            |
| `DN().Monat().Monat`{data-clipboard-text="DN().Monat().Monat"}                                               | Zeigt das ausgewählte Monat an                                        |
| `DN().Monat().MonatJahr`{data-clipboard-text="DN().Monat().MonatJahr"}                                       | Zeigt das ausgewählte Monat und Jahr an                               |
...
| `DN().Monat().UDG`{data-clipboard-text="DN().Monat().UDG"}                                                   | Nummer des Unterdienstgebers des ausgewählten Monats                  |
| `DN().Monat().NurAufrollung`{data-clipboard-text="DN().Monat().NurAufrollung"}                               | Ob Monat nur aufgerollt wurde – Wahr/Falsch                           |
...
| `DN().ZR().AktuellesMonat`{data-clipboard-text="DN().ZR().AktuellesMonat"}                                   | Zeigt das aktuelle Monat in Zahlen an                                 |
| `DN().ZRAktDV().AktuellesMonat`{data-clipboard-text="DN().ZRAktDV().AktuellesMonat"}                         | Zeigt das aktuelle Monat des aktiven Dienstverhältnisses in Zahlen an |
| `DN().ZR().JahreEintritt`{data-clipboard-text="DN().ZR().JahreEintritt"}                                     | Zeigt die Anzahl der Jahre seit dem Eintritt an                       |
...
| `DN().ZR().MonateEintritt`{data-clipboard-text="DN().ZR().MonateEintritt"}                                   | Zeigt die Anzahl der Monate seit dem Eintritt an                      |
...
| `DN().ZR().TageEintritt`{data-clipboard-text="DN().ZR().TageEintritt"}                                       | Zeigt die Anzahl der Tage seit dem Eintritt an                        |
...
| `DN().PartnerSvNr`{data-clipboard-text="DN().PartnerSvNr"}                         | Ersten vier Stellen der SV-Nummer des (Ehe)Partners                   |
...
| `DN().Auwahlkriterium`{data-clipboard-text="DN().Auwahlkriterium"}                   | Nummer des Auswahlkriterium                           |
...
| `DN().Monat().BeschäftigtInWo`{data-clipboard-text="DN().Monat().BeschäftigtInWo"}               | Anzahl Tage Beschäftigt in der Woche                                                |
...
| `DN().Lehrlingsfreibetrag`{data-clipboard-text="DN().Lehrlingsfreibetrag"}                       | Kein Lehrlingsfreibetrag aktiviert (Wahr/Falsch)                                    |
...
| `DN().Monat().AngNachTabak`{data-clipboard-text="DN().Monat().AngNachTabak"}                     | Angehöriger nach Tabakmonopolgesetz aktiviert ist (Wahr/Falsch)                     |
| `DN().AnFirmaBeteiligt`{data-clipboard-text="DN().AnFirmaBeteiligt"}                             | DN an Firma beteiligt aktiviert ist (Wahr/Falsch)                                   |
...
| `DN().Monat().KV().Taetigkeitsgruppe`{data-clipboard-text="DN().Monat().KV().Taetigkeitsgruppe"}                 | Name aktuelle Tätigkeitsgruppe                               |
...
| `DN().Monat().KV().LetzteTaetigkeitsgruppeNr`{data-clipboard-text="DN().Monat().KV().LetzteTaetigkeitsgruppeNr"} | Interne Nummer letzten Tätigkeitsgruppe                      |
...
| `DN().Monat().KV().StufeKuerzung`{data-clipboard-text="DN().Monat().KV().StufeKuerzung"}                         | Zeit, die Monate, um welche die Stufe gekürzt wird           |
...
| `DN().Monat().KV().HochrechnungsfaktorAbw`{data-clipboard-text="DN().Monat().KV().HochrechnungsfaktorAbw"}       | Wert des abw. Hochrechnungsfaktors                           |
| `DN().Monat().KV().NAZ`{data-clipboard-text="DN().Monat().KV().NAZ"}                                             | Normalarbeitszeit laut Kollektivvertrag                      |
| `DN().Monat().KV().BezugAliquot`{data-clipboard-text="DN().Monat().KV().BezugAliquot"}                           | Wert aliquoter Kollektivvertrag-Bezug                        |
...
| `DN().Monat().KV().TeilerAbw`{data-clipboard-text="DN().Monat().KV().TeilerAbw"}                                 | Abw. Stundenteiler bei Teilzeit                              |
...
| `DN().KarenzurlaubVon`{data-clipboard-text="DN().KarenzurlaubVon"}                                         | Datum des Beginn des Karenzurlaubes                                     |
| `DN().KarenzurlaubBis`{data-clipboard-text="DN().KarenzurlaubBis"}                                         | Datum des Ende des Karenzurlaubes                                       |
...
| `DN().Monat().KUEVon`{data-clipboard-text="DN().Monat().KUEVon"}                                           | Datum des Beginnes der Kündigungsentschädigung                          |
| `DN().Monat().KUEBis`{data-clipboard-text="DN().Monat().KUEBis"}                                           | Datum des Ende der Kündigungsentschädigung                              |
...
| `DN().Monat().UEVon`{data-clipboard-text="DN().Monat().UEVon"}                                             | Datum des Beginnes der Urlaubsersatzleistung                            |
...
| `DN().Monat().TeilzeitVon`{data-clipboard-text="DN().Monat().TeilzeitVon"}                                 | Datum des Beginnes der Teilzeitbeschäftigung                            |
...
| `DN().Monat().PendlerpauschaleText`{data-clipboard-text="DN().Monat().PendlerpauschaleText"}                                         | Art der Pendlerpauschale (zB „klein 20 -- 40 km")                          |
...
| `DN().Monat().FahrtabeAbwWiederkend`{data-clipboard-text="DN().Monat().FahrtabeAbwWiederkend"}                                       | Abw. Fahrttage wiederkehrend aktiviert (Wahr/Falsch)                       |
...
| `DN().Monat().KuerzungDZ`{data-clipboard-text="DN().Monat().KuerzungDZ"}                                                             | Befreiung von DZ aktiviert (Wahr/Falsch)                                   |
...
| `DN().Monat().KostenuebernahmeOeffiTicketNurL16`{data-clipboard-text="DN().Monat().KostenuebernahmeOeffiTicketNurL16"}               | Nur Ausweis am Lohnkonto u. L16 aktiviert (Wahr/Falsch)                    |
...
| `DN().Monat().FallweiseBeschaeftigt`{data-clipboard-text="DN().Monat().FallweiseBeschaeftigt"}                     | Fallweise Beschäftig aktiviert (Wahr/Falsch)                         |
| `DN().Monat().TageFallweise`{data-clipboard-text="DN().Monat().TageFallweise"}                                     | Markierte Tage bei Fallweise Beschäftigt                             |
...
| `DN().Monat().BonusgruppenNachSept2009`{data-clipboard-text="DN().Monat().BonusgruppenNachSept2009"}               | Bonusgruppe nach 1. Sept. 2009 erlauben aktiviert (Wahr/Falsch)      |
...
| `DN().Monatssumme().Monat`{data-clipboard-text="DN().Monatssumme().Monat"}                         | Zeigt Monatskürzel und Jahr der Monatssumme an                             |
...
| `DN().Monat().NurMvBemKrankheit`{data-clipboard-text="DN().Monat().NurMvBemKrankheit"}             | Ob nur ein Wert MV-Bemessung Krankheit abgerechnet wurde (Wahr/Falsch)     |
| `DN().Monat().NurMvBemMutterschutz`{data-clipboard-text="DN().Monat().NurMvBemMutterschutz"}       | Ob nur ein Wert MV-Bemessung Mutterschutz abgerechnet wurde (Wahr/Falsch)  |
| `DN().Monat().NurMvBemPraesenzdienst`{data-clipboard-text="DN().Monat().NurMvBemPraesenzdienst"}   | Ob nur ein Wert MV-Bemessung Präsenzdienst abgerechnet wurde (Wahr/Falsch) |
| `DN().Monat().NurSvBemessung`{data-clipboard-text="DN().Monat().NurSvBemessung"}                   | Ob nur ein Wert in SV-Bemessung abgerechnet wurde (Wahr/Falsch)            |
...
| `DN().ZR().Monat().Monat`{data-clipboard-text="DN().ZR().Monat().Monat"}                           | Zeigt das Monat und Jahr an                                                |
| `DN().ZRAktDV().Monat().Monat`{data-clipboard-text="DN().ZRAktDV().Monat().Monat"}                 | Zeigt das Monat und Jahr an (aktives Dienstverhältnis)                     |
...
| **Formel**                                                                           | **Beschreibung**                                                              |
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
| `DN().Üst_Alle().Monat().Monat`{data-clipboard-text="DN().Üst_Alle().Monat().Monat"} | Zeigt das Monatskürzel und Jahr an                                            |
| `DN().Üst_Alle().Monat().Wert`{data-clipboard-text="DN().Üst_Alle().Monat().Wert"}   | Wert der ausgewählten Über- und/oder Mehrarbeitsstunden                       |
| `DN().Üst_Alle().Name`{data-clipboard-text="DN().Üst_Alle().Name"}                   | Text der ausgewählten Über- und/oder Mehrarbeitsstunden                       |
| `DN().Üst_Alle().Nummer`{data-clipboard-text="DN().Üst_Alle().Nummer"}               | Nummer der ausgewählten Über- und/oder Mehrarbeitsstunden                     |
| `DN().Üst_WK().Monat().Monat`{data-clipboard-text="DN().Üst_WK().Monat().Monat"}     | Zeigt das Monatskürzel und Jahr an                                            |
...
| `DN().Üst_WK().Name`{data-clipboard-text="DN().Üst_WK().Name"}                       | Text der ausgewählten und wiederkehrenden Über- und/oder Mehrarbeitsstunden   |
...
| **Formel**                                                                                                             | **Beschreibung**                                                             |
| ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `DN().UrlaubsjahrBeginn`{data-clipboard-text="DN().UrlaubsjahrBeginn"}                                                 | Datum im Beginn Urlaubsjahr                                                  |
...
| `DN().KrankenstandskarteiJaNein`{data-clipboard-text="DN().KrankenstandskarteiJaNein"}                               | Krankenstandkartei aktiviert (Wahr/Falsch)                                                                                   |
...
| `DN().Krankenstandskartei().Dauer`{data-clipboard-text="DN().Krankenstandskartei().Dauer"}                           | Krankenstandskartei - Tage der Dauer                                                                                         |
...
| `DN().ZR().Monat().TageKrankOhneFeiertage`{data-clipboard-text="DN().ZR().Monat().TageKrankOhneFeiertage"}           | Anzahl der Krankentage ohne Freitage                                                                                         |
| `DN().ZRAktDV().Monat().TageKrankOhneFeiertage`{data-clipboard-text="DN().ZRAktDV().Monat().TageKrankOhneFeiertage"} | Anzahl der Krankentage ohne Freitage (aktives Dienstverhältnis)                                                              |
...
| `DN().Monat().ErweiterterPfaendungsschutz`{data-clipboard-text="DN().Monat().ErweiterterPfaendungsschutz"}       | Erweiterter Pfändungsschutz in Monate                    |
...
| `DN().Monat().SonderzahungAbweichend`{data-clipboard-text="DN().Monat().SonderzahungAbweichend"}                 | Abweichende Berechnungsgrundlage Sonderzahlungen         |
...
| `DN().Monat().Kostenstelle().Prozent`{data-clipboard-text="DN().Monat().Kostenstelle().Prozent"} | Prozentsatz der Kostenstelle |
...
| `DN().Monat().SZBetrag`{data-clipboard-text="DN().Monat().SZBetrag"}                                                           | SZ vereinbart Betrag                                                    |
| `DN().Monat().VereinbartesEntgelt`{data-clipboard-text="DN().Monat().VereinbartesEntgelt"}                                     | Vereinbartes Entgelt Betrag                                             |
...
| **Formel**                                                                                                                                                   | **Beschreibung**                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| `DN().Monat().KurzarbeitCovid19().AbgerechnetInMonth`{data-clipboard-text="DN().Monat().KurzarbeitCovid19().AbgerechnetInMonth"}                             | Zeigt an ob in dem ausgewählten Monat Kurzarbeit abgerechnet wurde (Wahr/Falsch) |
...
| `DN().KurzarbeitCovid19().AMSProjektNr`{data-clipboard-text="DN().KurzarbeitCovid19().AMSProjektNr"}                                                         | AMS-Projekt Nummer                                                               |
...
| `DN().KurzarbeitCovid19().NazLtKv`{data-clipboard-text="DN().KurzarbeitCovid19().NazLtKv"}                                                                   | Normalarbeitszeit laut KV                                                        |
...
| `DN().KurzarbeitCovid19().UestdPauschUnwiderruflich`{data-clipboard-text="DN().KurzarbeitCovid19().UestdPauschUnwiderruflich"}                               | Überstundenpauschale unwiderruflich (Wahr/Falsch) aktiviert                      |
