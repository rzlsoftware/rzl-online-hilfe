...
| `Note.Summe.Gesamtbetrag.Text`    | Text laut Programmoptionen                    |
| `Note.Summe.Gesamtbetrag.Betrag`  | Summe des Gesamtbetrags                       |
...
| `Note.Zahlung.Bankname`       | Name der Bank (laut Stammdaten des Kanzleibereiches)         |
| `Note.Zahlung.BIC`            | Bank Identifier Code                                         |
| `Note.Zahlung.Frist`          | Zahlungsfrist in Tagen                                       |
| `Note.Zahlung.IBAN`           | International Bank Account Number                            |
| `Note.Zahlung.QRCode`         | Überweisungsdaten als QR-Code (Bild)                         |
| `Note.Zahlung.Referenz`       | Zahlungsreferenz (12-stellig numerisch)                      |
