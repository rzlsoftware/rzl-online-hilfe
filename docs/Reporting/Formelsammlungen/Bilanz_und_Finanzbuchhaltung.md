...
| **Formel**                                                                       | **Beschreibung**                                                           |
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `ZR.AktMonat`{data-clipboard-text="ZR.AktMonat"}                                 | Zeigt das letzte Monat des Wirtschaftsjahres an                            |
...
| `ZR.Jahr().Ende`{data-clipboard-text="ZR.Jahr().Ende"}                           | Letzter Tag es Wirtschaftsjahres                                           |
...
| `Stamm.FinanzZahlungsreferenz`{data-clipboard-text="Stamm.FinanzZahlungsreferenz"} | Zahlungseferenz des Finanzamtes                  |
...
| `Bil().Monat().Monat`{data-clipboard-text="Bil().Monat().Monat"}               | Zeigt das ausgewählte Monat an                                                                         |
...
| `Bil().Text`{data-clipboard-text="Bil().Text"}                                 | Text der ausgewählten Bilanzposition                                                                   |
...
| `BilAlt().Monat().Monat`{data-clipboard-text="BilAlt().Monat().Monat"}         | Zeigt das ausgewählte Monat an der alten Gliederung                                                    |
...
| `BilAlt().MonatWJ().Monat`{data-clipboard-text="BilAlt().MonatWJ().Monat"}     | Zeigt das ausgewählte Monat im WJ der alten Gliederung                                                 |
...
| `BilAlt().Text`{data-clipboard-text="BilAlt().Text"}                           | Text der ausgewählten Bilanzposition der alten Gliederung                                              |
| `BilAlt().ÜS`{data-clipboard-text="BilAlt().ÜS"}                               | Überschrift der Bilanzposition, z.B. G (große Überschrift) der alten Gliederung                        |
| `Bil().MonatWJ().Monat`{data-clipboard-text="Bil().MonatWJ().Monat"}           | Zeigt das ausgewählte Monat im WJ der Gliederung                                                       |
...
| `Guv().Monat().Monat`{data-clipboard-text="Guv().Monat().Monat"}                                                 | Zeigt das ausgewählte Monat an                                                      |
...
| `GuV().MonatWJ().Monat`{data-clipboard-text="GuV().MonatWJ().Monat"}                                             | Zeigt das ausgewählte Monat im jeweiligen WJ an                                     |
...
| `Guv().Text`{data-clipboard-text="Guv().Text"}                                                                   | Text der ausgewählten GuV-Position                                                  |
...
| `GuvAlt().Monat().Monat`{data-clipboard-text="GuvAlt().Monat().Monat"}                                           | Zeigt das ausgewählte Monat an der alten Gliederung                                 |
...
| `GuVAlt().MonatWJ().Monat`{data-clipboard-text="GuVAlt().MonatWJ().Monat"}                                       | Zeigt das ausgewählte Monat der alten Gliederung im jeweiligen WJ an                |
...
| `GuvAlt().Text`{data-clipboard-text="GuvAlt().Text"}                                                             | Text der ausgewählten GuV-Position der alten Gliederung                             |
...
| `Ker().Monat().Monat`{data-clipboard-text="Ker().Monat().Monat"}                 | Zeigt das ausgewählte Monat an                                               |
...
| `Ker().MonatWJ().Monat`{data-clipboard-text="Ker().MonatWJ().Monat"}             | Zeigt das ausgewählte Monat im WJ an                                         |
...
| `KoArt().Monat().Monat`{data-clipboard-text="KoArt().Monat().Monat"}                                           | Zeigt das ausgewählte Monat an                                                 |
...
| `KoArt().Text`{data-clipboard-text="KoArt().Text"}                                                             | Text der Kostenart                                                             |
...
| `KoArt().Stelle().Monat().Monat`{data-clipboard-text="KoArt().Stelle().Monat().Monat"}                         | Zeigt das ausgewählte Monat an                                                 |
...
| `KoStel().Monat().Monat`{data-clipboard-text="KoStel().Monat().Monat"}                                         | Zeigt das ausgewählte Monat an                                                 |
...
| `KoTraeger().Art().Monat().Monat`{data-clipboard-text="KoTraeger().Art().Monat().Monat"}                       | Zeigt das ausgewählte Monat an                                                 |
...
| `KoTraeger().Monat().Monat`{data-clipboard-text="KoTraeger().Monat().Monat"}                                   | Zeigt das ausgewählte Monat an                                                 |
...
| `KoTraeger().Stelle().Monat().Monat`{data-clipboard-text="KoTraeger().Stelle().Monat().Monat"}                 | Zeigt das ausgewählte Monat an                                                 |
...
| `Konto().Monat().Monat`{data-clipboard-text="Konto().Monat().Monat"}                     | Zeigt das ausgewählte Monat an                          |
...
| `Konto().MonatWJ().Monat`{data-clipboard-text="Konto().MonatWJ().Monat"}                 | Zeit das ausgewählte Monat an                           |
...
| **Formel**                                                                                                   | **Beschreibung**                                                             |
| ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| `USt().Land().Monat().EUStFinanz`{data-clipboard-text="USt().Land().Monat().EUStFinanz"}                     | EUSt für das jeweilige Monat                                                 |
| `USt().Land().Monat().Monat`{data-clipboard-text="USt().Land().Monat().Monat"}                               | Monat der Ust                                                                |
| `USt().Land().Monat().Zahllast`{data-clipboard-text="USt().Land().Monat().Zahllast"}                         | Zahllast für das jeweilige Monat                                             |
| `USt().Land().MonatWJ().EUStFinanz`{data-clipboard-text="USt().Land().MonatWJ().EUStFinanz"}                 | EUSt für das jeweilige Monat im WJ                                           |
| `USt().Land().MonatWJ().Monat`{data-clipboard-text="USt().Land().MonatWJ().Monat"}                           | Monat der Ust im WJ                                                          |
| `USt().Land().MonatWJ().Zahllast`{data-clipboard-text="USt().Land().MonatWJ().Zahllast"}                     | Zahllast für das jeweilige Monat im WJ                                       |
...
| `USt().Land().Kennziffer().Monat().Monat`{data-clipboard-text="USt().Land().Kennziffer().Monat().Monat"}     | Kennziffer des ausgewählten Ust-Landes für das jeweilige Monat               |
| `USt().Land().Kennziffer().Monat().Wert`{data-clipboard-text="USt().Land().Kennziffer().Monat().Wert"}       | Wert der Kennziffer des ausgewählten Ust-Landes EUSt für das jeweilige Monat |
| `USt().Land().Kennziffer().MonatWJ().Monat`{data-clipboard-text="USt().Land().Kennziffer().MonatWJ().Monat"} | Kennziffer des ausgewählten Ust-Landes für das jeweilige Monat               |
| `USt().Land().Kennziffer().MonatWJ().Wert`{data-clipboard-text="USt().Land().Kennziffer().MonatWJ().Wert"}   | Wert der Kennziffer des ausgewählten Ust-Landes EUSt für das jeweilige Monat |
...
| **Formel**                                                                                         | **Beschreibung**                                          |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `Anl().Jahr().Abgang`{data-clipboard-text="Anl().Jahr().Abgang"}                                   | Restbuchwert des Abganges                                 |
...
| `Anl().Jahr().BWRAlt`{data-clipboard-text="Anl().Jahr().BWRAlt"}                                   | BWR VJ                                                    |
| `Anl().Jahr().BWRSubvention`{data-clipboard-text="Anl().Jahr().BWRSubvention"}                     | Subvention                                                |
| `Anl().Jahr().BWRSubventionAlt`{data-clipboard-text="Anl().Jahr().BWRSubventionAlt"}               | Subvention VJ                                             |
| `Anl().Jahr().BWRSubventionAufloesung`{data-clipboard-text="Anl().Jahr().BWRSubventionAufloesung"} | Auflösung Subvention                                      |
| `Anl().Jahr().BWRSubventionUmbuchung`{data-clipboard-text="Anl().Jahr().BWRSubventionUmbuchung"}   | Umbuchung Subvention                                      |
...
| `Anl().Jahr().IFB`{data-clipboard-text="Anl().Jahr().IFB"}                                         | IFB                                                       |
...
| `Anl().Jahr().VbBWR`{data-clipboard-text="Anl().Jahr().VbBWR"}                                     | Wert des Verbrauches der Bewertungsreserve                |
...
| **Formel**                                                                                               | **Beschreibung**                                          |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `AnlBil().Jahr().Abgang`{data-clipboard-text="AnlBil().Jahr().Abgang"}                                   | Restbuchwert des Abganges                                 |
...
| `AnlBil().Jahr().BWRAlt`{data-clipboard-text="AnlBil().Jahr().BWRAlt"}                                   | Wert der BWR Alt                                          |
| `AnlBil().Jahr().BWRSubvention`{data-clipboard-text="AnlBil().Jahr().BWRSubvention"}                     | Subvention                                                |
| `AnlBil().Jahr().BWRSubventionAlt`{data-clipboard-text="AnlBil().Jahr().BWRSubventionAlt"}               | Wert der Subvention VJ                                    |
...
| `AnlBil().Jahr().IFB`{data-clipboard-text="AnlBil().Jahr().IFB"}                                         | IFB                                                       |
...
| `AnlBil().Jahr().VbBWR`{data-clipboard-text="AnlBil().Jahr().VbBWR"}                                     | Wert des Verbrauches der Bewertungsreserve                |
...
| `KlientBankkonto().Kundendatenfeld_erster_OP`{data-clipboard-text="KlientBankkonto().Kundendatenfeld_erster_OP"} | Zahlungsreferenz des ersten OP der ausgewählten Bank |
...
| `Konto.PLZ`{data-clipboard-text="Konto.PLZ"}                                         | PLZ des Kunden                                                                                                                                   |
| `Konto.SVNr`{data-clipboard-text="Konto.SVNr"}                                       | SV Nummer des Kunden                                                                                                                             |

### Buchungen / Offene Posten

| **Formel**                                                                                   | **Beschreibung**                                        |
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| `MahnOP.Beleg`{data-clipboard-text="MahnOP.Beleg"}                                           | Belegnummer des jeweiligen Buchung                      |
| `MahnOP.Belegkreis`{data-clipboard-text="MahnOP.Belegkreis"}                                 | Belegkreis des jeweiligen Buchung                       |
| `MahnOP.Datum`{data-clipboard-text="MahnOP.Datum"}                                           | Datum der jeweiligen Buchung                            |
| `MahnOP.Fremdbeleg`{data-clipboard-text="MahnOP.Fremdbeleg"}                                 | Fremdbelegnummer der jeweiligen Buchung, wenn vorhanden |
...
| `MahnOP.Mahnstufe`{data-clipboard-text="MahnOP.Mahnstufe"}                                   | Derzeitige Mahnstufe der jeweiligen Buchung             |
| `MahnOP.Mahnstufe_Text`{data-clipboard-text="MahnOP.Mahnstufe_Text"}                         | Text der derzeitigen Mahnstufe der jeweiligen Buchung   |
...
| `WeitereMahndaten.Letzter_Zahlungseingang`{data-clipboard-text="WeitereMahndaten.Letzter_Zahlungseingang"} | Datumseingabe bei „letzter Zahlungseingang"   |
