...
Dieser Aufruf zeigt die über Elda importierten Krankenstandsbescheinigungen an (vgl. Kapitel 9.7 Krankenstandsbescheinigungen herunterladen und übernehmen, Seite [182](#_Ref66279344)).
...
In diesem Programmteil werden die für die Dienstnehmer angelegten Drittschuldnererklärungen angezeigt (vgl. Kapitel 22 Exekutionen, Seite [302](#section-16)).

# Aufruf Exekutionsbeträge

Hier erfolgt eine Auflistung der bereits exekutierten Beträge zu den jeweiligen Drittschuldnererklärungen. Exekutionsbeträge die manuell nacherfasst wurden, sind farblich anders dargestellt (vgl. Kapitel 22 Exekutionen, Seite [302](#section-16)).
...
In diesem Programmteil werden die im Abrechnungsbildschirm *Arbeits- und Entgeltsbestätigung Krankengeld* (vgl. Kapitel 5.21, Seite [125](#arbeits--und-entgeltsbestätigung-krankengeld)) abgerechneten Bestätigungen angezeigt.

# Aufruf Arbeits- und Entgeltbestätigung Wochengeld

Durch Anwahl dieses Programmteiles werden die im Abrechnungsbildschirm *Arbeits- und Entgeltsbestätigung Wochengeld* (vgl. Kapitel 5.22, Seite [129](#arbeits--und-entgeltsbestätigung-wochengeld)) abgerechneten Bestätigungen angezeigt.
...
Durch Anwahl dieses Programmteiles wird die Dienstnehmersuche gestartet. Vgl. 1.5.1 Dienstnehmer Suche, Seite [21](#dienstnehmer-suche).

# Aufruf WEBEKU Abfrage

Durch Anwahl dieses Programmteils öffnet sich der WEBEKU Dialog. Siehe Kapitel 42.3 Aufruf in der RZL Lohnverrechnung, Seite [556](#aufruf-in-der-rzl-lohnverrechnung).

# Aufruf SV Nr. Abfrage

Durch Anwahl dieses Programmteils öffnet sich die WEBEKU Versicherungsnummernabfrage. Siehe Kapitel 42.4 Versicherungsnummernabfrage, Seite [560](#versicherungsnummernabfrage).
