...
In diesem Eingabebildschirm kann die *Urlaubskartei* des Dienstnehmers geführt werden. Der [Ausdruck der Urlaubskartei](../Ausdrucke/Ausdruck_Abrechnungen.md) ist im *Ausdruckmenü* unter *Stammdaten* möglich. Die Eintragungen in der Urlaubskartei werden auch für die Berechnung der [Urlaubsrückstellung](../Rückstellungen/Urlaubsrueckstellung.md) verwendet. Es können wahlweise *Werktage*, *Arbeitstage* oder *Stunden* eingetragen werden.
...
Auf den [Abrechnungen der Dienstnehmer](../Ausdrucke/Ausdruck_Abrechnungen.md) kann die Urlaubskartei wahlweise normal oder im *Detail* gedruckt werden.
