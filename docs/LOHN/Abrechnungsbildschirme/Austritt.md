...
Eingabe des arbeitsrechtlichen Endes des Dienstverhältnisses. Das Austrittsdatum muss im Abrechnungsmonat liegen. Aufgrund des Austrittsdatums werden die SV-Tage und LSt-Tage berechnet. Ist *Aliquotierung* (Kapitel 5.4 Stammdaten-Fristen, Seite [60](#stammdaten-fristen)) angewählt, wird der Bruttolohn entsprechend aliquotiert. In den nächsten Monaten wird die Abrechnung automatisch unterdrückt. Der Dienstnehmer kann dann nur mittels Wiedereintritt im selben Monat oder zu einem späteren Zeitraum abgerechnet werden.

#### **Grund**

Eingabe des Austrittsgrundes durch Auswahl aus der von der ÖGK vorgegebenen Liste. Für die Abmeldung muss ein Austrittsgrund angewählt werden. Bei der Eingabe eines *sonstigen Grundes* wird auf die angelegten *Standardtexte* (Kapitel 8.1 Kanzlei-Texte, Seite [165](#kanzlei-texte)) zurückgegriffen.
...
Vgl. Kapitel 37.4 Abrechnung Mutterschutz/Karenzurlaub, Seite [436](#abrechnung-mutterschutzkarenzurlaub).
...
Grundsätzlich wird das *Ende der Beitragspflicht* vom Programm vorgeschlagen. In Ausnahmefällen kann hier ein vom Austrittsdatum abweichendes Ende der BV-Beitragspflicht eingetragen werden. Vgl. Kapitel 21.4.2 Ende der BV-Beitragspflicht, Seite [292](#ende-der-bv-beitragspflicht)
...
!!! warning "Hinweis"
    Wurde bereits eine Urlaubsersatzleistung eingetragen und Sie möchten die Einheit (Werktage, Arbeitstage, Stunden) umstellen, erfolgt folgender
...
!!! warning "Hinweis"
    Informationen zur Urlaubsersatzleistung bei Tod des Dienstnehmers finden Sie im Kapitel 37.18 Urlaubsersatzleistung bei Tod des Dienstnehmers, Seite [473](#urlaubsersatzleistung-bei-tod-des-dienstnehmers).
