...
Über den Menüpunkt *Bearbeiten / Datenexport / Datenexport* wählen Sie zunächst einen bestimmten Monat und definieren, ob der gesamte Klient oder einzelne Dienstnehmer exportiert werden sollen. Die [*Listenform*](../LOHN/Datenexport.md/#erstellung-aufbau-der-daten-liste-export-datei) für den Datenexport muss einmalig angelegt werden.
