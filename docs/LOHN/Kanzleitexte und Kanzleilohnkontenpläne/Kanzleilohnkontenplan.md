...
Diese Kontonummern werden als Vorkontierung am Buchungsbeleg angedruckt (vgl. Kapitel 12.8.3, Seite [217](#buchungsbeleg)).

![Image](<img/image172.png>)

Das Eingabefeld *Höchste Belegkreisnummer* orientiert sich an der Anzahl der verwendeten Buchungskreise, die im Abrechnungsbildschirm *Stammdaten Fristen* (vgl. Kapitel 5.4, Seite [60](#stammdaten-fristen)) eingetragen werden.
