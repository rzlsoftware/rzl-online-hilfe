...
Die Anzahl der Unterhaltsberechtigten wird aus dem Abrechnungsbildschirm [*Stammdaten* *Dienstnehmer*](../Abrechnungsbildschirme/Stammdaten_Dienstnehmer.md) aus den Bereichen [*Ehepartner*](../Abrechnungsbildschirme/Stammdaten_Dienstnehmer.md/#ehepartner) und [*Kinder*](../Abrechnungsbildschirme/Stammdaten_Dienstnehmer.md/#kinder) übernommen, wenn dort das Feld *Unterhalt* aktiviert wird.
...
Neben der Option für die eigentlichen *Exekutionskosten*, gibt es die Möglichkeit die Kosten für die Drittschuldnererklärung einzubehalten. Der Abzug richtet sich nach der *Kostenvariante*, welche unter [*Stamm / Exekutionen*](../Exekutionen/Drittschuldnererklaerung.md/#kostenvariante) hinterlegt wurde. Diese Kosten reduzieren nicht das Existenzminimum des Dienstnehmers, sondern kürzen jenen Betrag, der an die Gläubiger überwiesen wird.
...
**Beispielrechnung: Quartalsweise Sonderzahlung**
...
Mit Hilfe der Option *quartalsweise Sonderzahlung* wird nur die **Hälfte des allgemeinen Grundbetrages** in Höhe von EUR 555,00 berücksichtigt.
...
Der errechnete Exekutionsbetrag und die Exekutionskosten können nur verändert werden, wenn im Abrechnungsbildschirm oben die Option *händische Berechnung* aktiviert wurde.
