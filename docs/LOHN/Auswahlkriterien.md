...
Diese Zuordnungen können beim [Ausdruck der Abrechnungen](../LOHN/Ausdrucke_allgemein/Ausdruck_Abrechnungen.md) und beim [Datenexport](../LOHN/Datenexport.md) verwendet werden.
...
Mit Hilfe des [Datenexportes](../LOHN/Datenexport.md/#erstellung-aufbau-der-daten-liste-export-datei) können unterschiedliche Listen erstellt und exportiert werden. Innerhalb des Datenexportes können die Dienstnehmer anhand der angelegten Auswahlkriterien eingeschränkt werden.
