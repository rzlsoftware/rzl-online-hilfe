...
Für die Beschreibung der verfügbaren Eingabefelder siehe Kapitel [Kontenplan anlegen](../Stammdaten/Kontenplane.md). Die Funktionen *Neues Konto* ***(2)*** sowie *Konto löschen* ***(3)*** und *Kontonummer ändern* ***(4)*** werden ebenso in diesem Kapitel beschrieben.
