...
Wird das neue Wirtschaftsjahr durch eine ***Jahresübernahme*** (siehe Kapitel [Wirtschaftsjahr mit Jahresübernahme anlegen](../../Klientenstammdaten/Allgemein/NeuesWirtschaftsjahranlegen.md)) angelegt, wird automatisch im Folgejahr ein Buchungsstapel *Eröffnungsbilanz* und die EB-Buchungen erstellt. Diese können Sie unter *Erfassen / Eröffnungsbilanz* aufrufen und sind mit einem **A** (Automatikbuchung) gekennzeichnet.
